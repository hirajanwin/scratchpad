...
![Downloads](https://img.shields.io/npm/dm/localeval.svg)
...
* [Docker support](#docker) and [Nginx reverse proxy config](#nginx-reverse-proxy-config-with-docker) :fire::fire: - Thanks to [@markuman](https://github.com/markuman)  
